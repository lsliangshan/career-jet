<template>
  <view class="w-full bg-white flex flex-col">
    ...
    <view class="w-full flex-1 flex flex-row items-start">
      <view
        class="w-[275rpx] h-full border-r border-r-[rgba(230,226,209,0.5)] border-r-[1rpx]"
        :style="{
      ...
      <view class="flex-1 h-full">
        <scroll-view class="w-full h-full" scroll-y>
          ...
          >
            <view
              class="w-full px-[24rpx] py-[12rpx] box-border rounded-[16rpx] flex flex-col justify-center transition-all duration-300"
...
import { ThemeColors, moralities } from "@/config/config";
