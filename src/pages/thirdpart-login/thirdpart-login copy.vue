    ...
    <Layout hasHeader>
      <template v-if="loginType === SupportedPlatform.BOSS">
        <image
          ...
          src="https://img.bosszhipin.com/beijin/weixin-service/20251027/e593d15eb4ff8e79469e767ee7b791e76dc982c6107196b76bb61e3b7bce0931da574d19d1d82c88.png"
        ></image>
        <view
          class="w-full h-[100rpx] flex flex-row items-center justify-center"
        >
          <view
            class="px-[36rpx] h-[80rpx] flex flex-row items-center jutify-center bg-[#42b983] active:bg-[#36ad6a] rounded-[8rpx] overflow-hidden"
            @click="test"
          >
...
function test() {
  const imageUrl =
    "https://img.bosszhipin.com/beijin/weixin-service/20251027/e593d15eb4ff8e79469e767ee7b791e76dc982c6107196b76bb61e3b7bce0931da574d19d1d82c88.png";
